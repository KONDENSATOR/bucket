...
(function() {
  var changed, close, commit, discard, ensure, filename, fork, fs, load, merge, oblit, onclosed, ondata, onerr, onlisted, onoblited, onstored, path, readline, remove, set, store, util, _;
